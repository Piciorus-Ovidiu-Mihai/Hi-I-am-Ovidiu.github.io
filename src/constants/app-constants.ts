...
const aboutMeSection = {
  ...
  description:
    'An enthusiast software engineer having an experience of building Web and Mobile applications using JavaScript, Angular, .NET Core, Spring Boot, HTML, CSS, SQL, Firebase, Java, Android and other nice tools.',
...
const skillsSection = {
  title: 'What I do ?',
  subTitle: 'SOFTWARE ENGINEER WHO LIKES TO BUILD SCALABLE WEB APPLICATION',
  skillsList: [
    {
